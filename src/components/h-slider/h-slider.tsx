...
const HSlider = function HSlider({
	...
	const onPanResponderMove = (_event: GestureResponderEvent, gestureState: PanResponderGestureState) => {
		onChange(_calculateValue(gestureState));
	};

	const onPanResponderRelease = (_event: GestureResponderEvent, gestureState: PanResponderGestureState) => {
		const newValue = _calculateValue(gestureState);
		onChange(newValue);
		onComplete?.(newValue);
	};
	const onPanResponderTerminate = (_event: GestureResponderEvent, gestureState: PanResponderGestureState) => {
